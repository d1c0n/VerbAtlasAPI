...
* VerbAtlas-1.0.3/ (contains the files for VerbAtlas 1.0.3) 
...
Note: frames with id > 999 (e.g. va:1000f - AUX_MOD) are not "semantic" frames,
...
For example:
    ...
    va:0001f	Agent	va:0081p|va:0103p	Theme	va:0002p|va:0051p	
    va:0002f	Agent	va:0081p	Theme	va:0081p
    va:0003f	Agent	va:0081p|va:0103p|va:0007p	Theme	va:0084p
    ...
...
are separated by a pipe (|). The default selectional preference for a role is
"entity" (id = va:0003p).
For example:
